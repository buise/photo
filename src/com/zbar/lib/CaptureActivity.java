...
public class CaptureActivity extends Activity implements Callback,
	...
	private TextView mDeviceIPText;
...
//							getResources().getString(R.string.msg_camera_framework_bug));
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mDeviceIPText = (TextView) findViewById(R.id.DeviceIP);
		mDeviceNameText = (TextView) findViewById(R.id.DeviceName);
	...
	public void handleDecode(String result, Bitmap barcode) {
		...
		Log.d("test", "---> handleDecode : " + result);
		
		Intent resIntent = new Intent();
		resIntent.putExtra("QR_RESULT", result);
		
		setResult(0x100, resIntent);
		finish();
...
//			if (mUniviewDeviceInfo != null) {
//				String device_name = mUniviewDeviceInfo.IPAddress;
//				String device_ip = mUniviewDeviceInfo.IPAddress;
//				
//				HomeSharedParam home_param = new HomeSharedParam(this);
//				if (home_param != null) {
//					home_param.saveDeviceName(device_name);
//					home_param.saveDeviceIP(device_ip);
//				}
//
//				if (device_ip != null) {
//					Controller controller = Controller.getController();
//					controller.setHOST_ADDRESS(device_ip);
//				}
//			}
			finish();
		} else if (v == mBtnRetry) {
